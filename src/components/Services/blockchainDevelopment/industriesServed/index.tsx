...
const IndustriesServedIntro = () => {
  const List = ({ text }) => (
    <p className="mb-5 flex items-center text-lg font-medium text-body-color">
      <span className="mr-4 flex h-[30px] w-[30px] items-center justify-center rounded-md bg-[#00a0e3] bg-opacity-10 text-[#00a0e3]">
        {checkIcon}
      </span>
      {text}
    </p>
          ...
          <div className="-mx-4 flex flex-wrap items-center">
              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Finance and Banking" />
                    <List text="Supply Chain Management" />
            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="relative mx-auto aspect-[25/24] max-w-[500px] lg:mr-0">
                <Image
                  src="/images/blockchainDevelopment/blockChainIndustriesServed.webp"
                  alt="blockchainDevelopment-image"
                  fill
