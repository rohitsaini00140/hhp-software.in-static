...
const processData: Process[] = [
  {
    id: 1,
    icon: (
      <svg fill="#00a0e3" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 56 56">
        <g>
          <g>
          </g>
    ...
    title: "Consultation",
    paragraph:
      "We begin the process with a comprehensive consultation. We work closely with you during this phase to understand your business goals, objectives, and challenges. This step is crucial in defining the project's scope and identifying the specific requirements.",
  },
  {
    id: 2,
    icon: (
      <svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="10" cy="6" r="4" stroke="#00a0e3" stroke-width="1.5" />
        <path d="M19 2C19 2 21 3.2 21 6C21 8.8 19 10 19 10" stroke="#00a0e3" stroke-width="1.5" stroke-linecap="round" />
        <path d="M17 4C17 4 18 4.6 18 6C18 7.4 17 8 17 8" stroke="#00a0e3" stroke-width="1.5" stroke-linecap="round" />
        <path d="M17.9975 18C18 17.8358 18 17.669 18 17.5C18 15.0147 14.4183 13 10 13C5.58172 13 2 15.0147 2 17.5C2 19.9853 2 22 10 22C12.231 22 13.8398 21.8433 15 21.5634" stroke="#00a0e3" stroke-width="1.5" stroke-linecap="round" />
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M17 17L22 12L17 7M7 7L2 12L7 17M14 3L10 21" stroke="#00a0e3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      </svg>
    ),
    title: "Development",
    paragraph:
  ...
  },
  {
    id: 5,
    icon: (
      <svg fill="#00a0e3" height="800px" width="800px" version="1.1" id="XMLID_101_" xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24">
        <g id="launch">
          <g>
    ...
    icon: (
      <svg width="800px" height="800px" viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg">
        ...
        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          <g id="support" fill="#00a0e3" transform="translate(42.666667, 42.666667)">
