            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center ">
                ...
                <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                  <Link
                    href="/contact"
                    className="inline-block rounded-sm bg-[#ff6600] px-6 py-2 text-base font-semibold text-white duration-300 ease-in-out hover:bg-[#ff6600]/90 dark:bg-white/10 dark:text-white dark:hover:bg-white/5"
                  >
                    Talk to us
                  </Link>
                </div>
